...
const double ENERGY= 400.00;		// 12C Beam energy (MeV/u) from Atima
const int CHARGE= 6;			// Charge number of the incoming nucleus
const int A= 12;			// Mass number of the incoming nucleus
